...
import "./searchBox.light.css";
import "./searchBox.dark.css";
import React from "react";

const SearchBox = (props) => {
  return (
    <div>
      <form action="/search" className="searchBox controls">
        <input type="text" onChange={props.showRecommendations} name="q" className="input" placeholder=" " />
        ...
        <StyledButton className="image-search" type={'button'} onClick={props.toggleNav}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 0 24 24"
